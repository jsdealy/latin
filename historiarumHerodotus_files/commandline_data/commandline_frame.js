...
(() => {
  ...
  var filter2 = /* @__PURE__ */ _curry2(/* @__PURE__ */ _dispatchable(["fantasy-land/filter", "filter"], _xfilter, function(pred, filterable) {
  ...
  var MinimalKey = class _MinimalKey {
    ...
    translate(keytranslatemap) {
      ...
      if (newkey === void 0 || this.translated)
        newkey = this.key;
      const result = new _MinimalKey(newkey, {
        altKey: this.altKey,
    ...
    constructor() {
      ...
      this.subconfigs = {
        "www.google.com": {
          ...
          nmaps: {
            gi: "composite focusinput -l ; text.end_of_line"
            // Fix #4706
          }
        },
      ...
      this.nmaps = {
        ...
        "<C-i>": "jumpnext",
        d: "tabclose",
        D: "js tri.excmds.composite('tabprev;', 'tabclose #')",
        // use JS to make counts error
       ...
       */
      this.commandlineterriblewebsitefix = "false";
      /**
       ...
       */
      this.urlparentignorefragment = "false";
      /**
       * Whether removal the url search parameter (the name after ? in the url)
       * is counted as a parent level.
       */
      this.urlparentignoresearch = "false";
      /**
       ...
       */
      this.urlparentignorepathregexp = "";
      /**
  ...
  var CompletionSource = class {
    constructor(prefixes2, options = { trailingSpace: true }) {
      this.prefixes = [];
  ...
  var CompletionSourceFuse = class extends CompletionSource {
    constructor(prefixes2, className, title, options = { trailingSpace: true }) {
      super(prefixes2, options);
      this.fuseOptions = {
        keys: ["fuseKeys"],
        shouldSort: true,
        includeScore: true,
  ...
  var everything = new ProgramMetadata(/* @__PURE__ */ new Map([
    ["src/excmds.ts", new FileMetadata(/* @__PURE__ */ new Map([]), /* @__PURE__ */ new Map([
      ...
      ["tabdiscard", new SymbolMetadata("Discard a tab without closing it to free up memory.", new FunctionType([new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ...
      ["sidebaropen", new SymbolMetadata("EXPERIMENTAL: like [[open]] but loads queries in the sidebar. Doesn't actually open the sidebar - see [[sidebartoggle]].\n\nNot all schemas are supported, such as `about:*` and Firefox's built-in search engines. Tridactyl's searchurls and jsurls work fine - `:set searchengine google` will be sufficient for most users.\n\nIf you try to open the command line in the sidebar things will break. `:hint -W sidebaropen` will open hints in the sidebar (potentially in the background if [[sidebartoggle]] has not been run).", new FunctionType([new ArrayType(new StringType(false, false), true, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ...
      ["unbindurl", new SymbolMetadata("Unbind a sequence of keys you have set with [[bind]] or [[bindurl]]. Note that this **kills** a bind, which means Tridactyl will pass it to the page on `pattern`. If instead you want to use the default setting again, use [[reseturl]].", new FunctionType([new StringType(false, false), new StringType(false, false), new StringType(false, false)], new TypeReferenceType("Promise", [new AnyType(true, false)], false, false), false, false), false)],
      ...
      ["tstmove", new SymbolMetadata("Move the current [Tree Style Tab](https://github.com/piroor/treestyletab) tree to be just in front of the tab specified. If TST is not installed, no error is raised and no action is taken.", new FunctionType([new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ["tstmoveafter", new SymbolMetadata("Move the current TST tree to be right after the tab specified.\n\nSee also: [[tstmove]]", new FunctionType([new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)],
      ["tstattach", new SymbolMetadata("Attach current tree as a child to the selected parent.\n\nSee also: [[tstmove]]", new FunctionType([new StringType(false, false)], new TypeReferenceType("Promise", [new VoidType(false, false)], false, false), false, false), false)]
    ]))],
    ["src/lib/config.ts", new FileMetadata(/* @__PURE__ */ new Map([["default_config", new ClassMetadata(/* @__PURE__ */ new Map([
      ...
      ["keyboardlayoutbase", new SymbolMetadata("Base keyboard layout to use when [[keyboardlayoutforce]] is enabled. At the time of writing, the following layouts are supported: `qwerty, azerty, german, dvorak, uk, ca, bepo`. Requires page reload to take effect.\n\nIf your layout is missing, you can contribute it with the help of https://gistpreview.github.io/?324119c773fac31651f6422087b36804 - please just open an `:issue` with your layout and we'll add it.\n\nYou can manually override individual keys for a layout with [[keyboardlayoutoverrides]].", new UnionType([
        ...
        new LiteralTypeType("workman", false, false)
      ], false, false), false)],
      ...
      ["commandlineterriblewebsitefix", new SymbolMetadata("Run a loop forcing the commandline to be reinserted if it is deleted as is typically the case after server-side rendering of bloated web frameworks such as React. Uses some CPU, so enable only on specific websites with `:seturl https://badwebsite\\.com commandlineterriblewebsitefix true`.\n\nA better workaround is to stop visiting websites that have so little respect for their users.", new UnionType([
        new LiteralTypeType("false", false, false),
        new LiteralTypeType("true", false, false)
      ], false, false), false)],
      ...
      ["markjumpnoisy", new SymbolMetadata("Whether `markjump` should pop-up with a notification", new UnionType([
        new LiteralTypeType("false", false, false),
        new LiteralTypeType("true", false, false)
      ], false, false), false)],
      ...
      ["editorusehtml", new SymbolMetadata("Try to preserve HTML tags when using an external editor.\n\nDefaults to false. Some sites work better with it set to true, see https://github.com/tridactyl/tridactyl/issues/3900", new StringType(false, false), false)],
      ...
      ["bmarkfoldersearch", new SymbolMetadata("Should folders be shown and filtered in bookmark searches.", new UnionType([
        new LiteralTypeType("false", false, false),
        new LiteralTypeType("true", false, false)
      ], false, false), false)],
...
statistics, so somewhere around 10k samples.`, new StringType(false, false), false)],
      ...
      ["hintstyles", new SymbolMetadata('Which css styles to add for hint elements.\n\nUse `hintstyles.fg` for text color, `hintstyles.bg` for background color, `hintstyles.outline` for outlines.\nValues may be set to "all" to enable the style for all hints, "active" to enable the style only for the currently selected hint, or "none" to disable the style completely.\n\nFor example, run\n`:set hintstyles.bg none` and reload the page to remove background colors from all hints.', new ObjectType(/* @__PURE__ */ new Map([["", new UnionType([
        new LiteralTypeType("all", false, false),
        new LiteralTypeType("active", false, false),
        new LiteralTypeType("none", false, false)
      ], false, false)]]), false, false), false)]
    ]))]]), /* @__PURE__ */ new Map([
      ...
      ["get", new SymbolMetadata("Get the value of the key target.\n\nIf the user has not specified a key, use the corresponding key from\ndefaults, if one exists, else undefined.", new FunctionType([new UnionType([
        ...
        new TypeReferenceType("... 97 more ...", [], false, false),
        new LiteralTypeType("hintstyles", false, false)
...
When adding updaters, don't forget to set("configversion", newversionnumber)!`, new FunctionType([], new TypeReferenceType("Promise", [new BooleanType(false, false)], false, false), false, false), true)],
      ...
      const flags = {
        ...
        "-s": (options, query3) => options.concat(
          Object.keys(settings).filter(
            (x) => {
              var _a;
              return (x + ((_a = default_config2.getMember(x)) == null ? void 0 : _a.doc)).toLowerCase().includes(query3);
            }
          ).map((setting) => {
  ...
  async function activeTabOnWindow(windowId) {
    ...
    if (isNaN(+address)) {
      try {
        ...
        if (
          ...
          address.endsWith("/") || url.hostname.indexOf(".") > 0 || url.port || url.password
        ) {
          return url.href;
        }
      } catch (e) {
  ...
  async function getBookmarks(query2) {
    let bookmarks = get2("bmarkfoldersearch") == "true" ? await fuseBookmarksSearch(query2) : await builtInBookmarksSearch(query2);
  ...
  async function builtInBookmarksSearch(query2) {
    const bookmarks = await browserBg.bookmarks.search({ query: query2 });
    return bookmarks.filter(isValidBookmark).map((b) => ({ path: "", ...b })).sort((a, b) => b.dateAdded - a.dateAdded);
  }
  var allBookmarks;
  var bookmarksFuse;
  async function fuseBookmarksSearch(query2) {
    allBookmarks = allBookmarks || await collectBookmarks();
    bookmarksFuse = bookmarksFuse || new Fuse(allBookmarks, {
      keys: ["path", "title", "url"],
      findAllMatches: true,
      ignoreLocation: true,
      ignoreFieldNorm: true,
    ...
    return query2 ? bookmarksFuse.search(query2).map((r) => r.item) : allBookmarks;
  }
  async function collectBookmarks() {
    ...
    return bookmarks.filter(isValidBookmark).map((bookmark) => ({
  ...
  function buildBookmarkPath(path, bookmark, bookmarksDictionary) {
  ...
  var bookmarkPaths;
  async function getBookmarkFolders(query2) {
    bookmarkPaths = bookmarkPaths || [
      ...new Set(
        (await collectBookmarkFolders()).filter((bookmark) => bookmark.path && bookmark.path != "/").map((bookmark) => bookmark.path)
      )
    ];
    const prefix = !query2 || query2 === "/" ? "/" : `.*${query2}`;
    const regex2 = new RegExp(`^${prefix}[^/]*/$`);
    return bookmarkPaths.filter((path) => regex2.test(path));
  }
  async function collectBookmarkFolders() {
    const bookmarks = await collectBookmarksAndFolders();
    const bookmarksDictionary = groupBookmarksById(bookmarks);
    return bookmarks.filter((bookmark) => bookmark.type === "folder").map((folder) => ({
  ...
  var BookmarkFolderCompletionSource = class extends CompletionSourceFuse {
    constructor() {
    ...
    async onInput(exstr) {
      ...
      this.options = (await getBookmarkFolders(path)).slice(0, 10).map((path2) => new BookmarkFolderCompletionOption(path2));
    }
    splitOnPrefix(exstr) {
  ...
  var BookmarkFolderCompletionOption = class extends CompletionOptionHTML {
    constructor(value) {
      super();
      this.value = value;
      this.fuseKeys = [];
  ...
  var logger2 = new logging_default("extensions");
  ...
  async function getNativeMessengerVersion(quiet = false) {
    ...
    if (res.version && !res.error) {
      logger3.info(`Native version: ${res.version}`);
  ...
  var _HistoryCompletionSource = class _HistoryCompletionSource extends CompletionSourceFuse {
    constructor(_parent) {
      super(
  ...
  _HistoryCompletionSource.DEFAULT_SECTION_HEADER = "History and bookmarks";
  ...
  // src/perf.ts
  var logger4 = new Logger("performance");
  ...
  var logger5 = new Logger("containers");
  ...
  var logger6 = new logging_default("state");
  ...
  var contentState = new Proxy(
    { mode: "normal" },
    {
      ...
      set(target, property, newValue) {
        logger6.debug("Content state changed!", property, newValue);
  ...
  var logger7 = new Logger("styling");
  ...
  async function theme(element) {
    ...
    const hintElemOptions = await getAsync("hintstyles");
    const hintElemRules = (hintElemOptions.fg === "all" ? "    color: var(--tridactyl-hint-active-fg) !important;\n" : "") + (hintElemOptions.bg === "all" ? "    background: var(--tridactyl-hint-bg) !important;\n" : "") + (hintElemOptions.outline === "all" ? "    outline: var(--tridactyl-hint-outline) !important;\n" : "");
    const activeElemRules = (hintElemOptions.fg !== "none" ? "    color: var(--tridactyl-hint-active-fg) !important;\n" : "") + (hintElemOptions.bg !== "none" ? "    background: var(--tridactyl-hint-active-bg) !important;\n" : "") + (hintElemOptions.outline !== "none" ? "    outline: var(--tridactyl-hint-active-outline) !important;\n" : "");
    hintElemCss.code = (hintElemRules !== "" ? ".TridactylHintElem {\n" + hintElemRules + "}\n" : "") + (activeElemRules !== "" ? ".TridactylHintActive {\n" + activeElemRules + "}\n" : "");
    if (hintElemCss.code !== "") {
    ...
    if (newTheme !== "default") {
      ...
      if (customCss.code) {
        ...
        logger7.error("Theme " + newTheme + " couldn't be found.");
      }
    }
  ...
  // src/state.ts
  var logger8 = new logging_default("state");
  var State = class {
    constructor() {
  ...
  browser.storage.local.get("state").then((res) => {
    if ("state" in res) {
      logger8.debug("Loaded initial state:", res.state);
      Object.assign(overlay, res.state);
    }
  }).catch((...args) => logger8.error(...args));
  var state = new Proxy(overlay, {
    ...
    set(target, property, value) {
      logger8.debug("State changed!", property, value);
      if (notBackground()) {
  ...
  function getCommandlineFns(cmdline_state) {
    return {
      ...
      insert_completion: async () => {
        ...
        const completion = completionSource == null ? void 0 : completionSource.completion;
        if (cmdline_state.activeCompletions) {
        ...
        if (completion) {
          cmdline_state.clInput.value = completion + ((completionSource == null ? void 0 : completionSource.trailingSpace) ? " " : "");
  ...
  // src/commandline_frame.ts
  var logger9 = new logging_default("cmdline");
  ...
  function getActiveCompletionSource() {
    if (!commandline_state.activeCompletions)
      return void 0;
    return commandline_state.activeCompletions.filter(
      ({ state: state2, completion }) => state2 === "normal" && completion !== void 0
    )[0];
  }
  ...
  function enableCompletions() {
    if (!commandline_state.activeCompletions) {
      ...
      logger9.debug(commandline_state.activeCompletions);
    }
  }
  var noblur = () => setTimeout(() => commandline_state.clInput.focus(), 0);
  function focus() {
    function consumeBufferedPageKeys(bufferedPageKeys) {
      ...
      if (bufferedPageKeys.length !== 0) {
        ...
        commandline_state.clInput.value = initialClInputValue + bufferedPageKeys.join("") + currentClInputValue.substring(initialClInputValue.length);
        clInputValueChanged();
      }
    }
    ...
    logger9.debug("commandline_frame clInput focus(), activeElement is clInput: " + (window.document.activeElement === commandline_state.clInput));
    messageOwnTab("stop_buffering_page_keys").then(consumeBufferedPageKeys);
  }
  ...
  commandline_state.clInput.addEventListener(
    ...
    function(keyevent) {
      if (!keyevent.isTrusted)
        return;
      logger9.debug("commandline_frame clInput keydown event listener", keyevent);
  ...
  commandline_state.clInput.addEventListener("input", () => {
    logger9.debug("commandline_frame clInput input event listener");
    clInputValueChanged();
  });
  ...
  function fillcmdline(newcommand, trailspace = true, ffocus = true) {
    logger9.debug("commandline_frame fillcmdline(newcommand = " + newcommand + " trailspace = " + trailspace + " ffocus = " + ffocus + ")");
    if (trailspace)
  ...
  logger9.debug("Added commandline_frame message listener");
  ...
  messageOwnTab("commandline_frame_ready_to_receive_messages");
})();
